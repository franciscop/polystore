...
declare function createStore<A extends {
    TYPE: StoreType;
}>(adapter: A, options?: Options): Store<Serializable> & {
    type: A["TYPE"];
};
...
export { type Adapter, type Options, type Serializable, type StoreInstance as Store, type StoreType, createStore as default };
